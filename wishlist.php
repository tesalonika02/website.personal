...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" class="delete-btn" onclick="return confirm('Hapus item ini dari wishlist?');"></a>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>"onclick="return confirm('Yakin hapus semua?');">Hapus Semua</a>
   </div>
