...
if(isset($_POST['update_qty'])){
   ...
   $message[] = 'item keranjang telah diubah';
}
...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="fas fa-times" class="delete-btn" onclick="return confirm('Hapus Item Ini Dari Keranjang?');"></a>
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?> "onclick="return confirm('Yakin Dihapus semua?');">Hapus Semua</a>
