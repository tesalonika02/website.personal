...
<section class="placed-orders">
   ...
   <div class="box">
      ...
      <p> Harga total : <span>Rp.<?= number_format($fetch_orders['total_price'], 0, ',', '.'); ?>/-</span> </p>
      ...
      <p>*Dimohon konfirmasi pada kami melalui kontak yang tersedia apabila pengiriman Anda telah diterima</p>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">belum ada yang kamu order:(</p>';
   }
   ?>
